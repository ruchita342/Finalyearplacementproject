...
<body>
    ...
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
            <img src="assets\img\hero-carousel\hero1.svg" class="img-fluid animated">
            <h2>Welcome to <span>DYPTC Placement Cell</span></h2>
            ...
            <div class="container" data-aos="zoom-out">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
                        <div class="img">
                            <img src="assets/img/feature7.webp" alt="" class="img-fluid">
                        </div>
                    </div>
    ...
    <button class="open-button is-size-5" onclick="openForm()" style="color:#890000 !important;"><strong><i class="fas fa-comment-alt"></i> Chat</strong></button>
