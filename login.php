            ...
            <div class="flex flex-wrap -m-4">
                <div class="col-lg-6 col-lg-6 col-12">
                    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                        <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="assets/img/login/login2.jpg" alt="blog">
                        <div class="p-6">
                ...
                <div class="col-lg-6 col-lg-6 col-12 ">
                    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                        <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="assets/img/login/login1.png" alt="blog">
                        <div class="p-6">
